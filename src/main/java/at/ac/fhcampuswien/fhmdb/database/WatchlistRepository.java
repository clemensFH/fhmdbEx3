...
public class WatchlistRepository {
    ...
    private WatchlistMovieEntity movieToWatchlist(Movie apiMovie) { // ToDo: Genres
        return new WatchlistMovieEntity(apiMovie.getId(), apiMovie.getTitle(), apiMovie.getDescription(), apiMovie.genresToSTring(), apiMovie.getReleaseYear(), apiMovie.getImgUrl(), apiMovie.getLengthInMinutes(), apiMovie.getRating());
    }
}
